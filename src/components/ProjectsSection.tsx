...
const projects: Project[] = [
  {
    id: "qa-assist",
    title: "QA-Assist",
    shortDescription: "AI-powered document review automation that transformed a 1-hour task into a single click",
    fullDescription: "Built an intelligent document review system that leverages machine learning to automatically analyze QA documents, identify discrepancies, and generate comprehensive reports. The tool integrates seamlessly with existing workflows and has been adopted across multiple teams.",
  ...
  },
  {
    ...
    shortDescription: "End-to-end automation system that processes 2,000+ tickets without human intervention",
    fullDescription: "Designed and implemented a sophisticated ticket automation platform that handles the complete lifecycle of support tickets—from classification to resolution. The system uses intelligent routing and automated responses to dramatically reduce manual workload.",
    impact: "2,000+ automated",
    technologies: ["Python", "Selenium", "SQL", "REST APIs", "CI/CD"],
  ...
  {
    id: "error-detection",
    title: "Legacy Error Detection Tool",
    shortDescription: "Uncovered 200+ hidden errors in systems that passed review for over 10 years",
    fullDescription: "Developed a deep-scanning tool that analyzes legacy systems to identify hidden bugs, edge cases, and potential vulnerabilities that traditional testing methods miss. The tool has become a critical part of the regression testing suite.",
    impact: "200+ errors found",
    technologies: ["Python", "Static Analysis", "SQL", "Data Mining"],
    category: ["highlighted", "automation"],
    features: [
  ...
  {
    id: "test-framework",
    title: "Modular Test Framework",
    shortDescription: "Reusable testing framework that reduced test development time by 60%",
    fullDescription: "Created a modular, extensible testing framework that provides standardized components for common testing patterns. The framework includes utilities for API testing, UI automation, data validation, and reporting.",
    impact: "60% faster tests",
    technologies: ["Python", "Pytest", "Playwright", "Docker"],
    category: ["automation"],
    features: [
      "Plug-and-play test components",
